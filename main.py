...
class NitroGen: # Initialise the class
    ...
    def main(self): # The main function contains the most important code
        ...
        if os.name == "nt": # If the system is windows
            print("")
            ctypes.windll.kernel32.SetConsoleTitleW("Nitro Generator and Checker - Made by Vlad44#6969") # Change the
        else: # Or if it is unix
            print(f'\33]0;Nitro Generator and Checker - Made by Vlad44#6969\a', end='', flush=True) # Update title of command prompt

        print("""Nitro generator""") # Print the title card
        time.sleep(2) # Wait a few seconds
        self.slowType("Made by: Vlad44#6969", .02) # Print who developed the code
        ...
        for i in range(num): # Loop over the amount of codes to check
            ...
            if os.name == "nt": # If the system is windows
                ctypes.windll.kernel32.SetConsoleTitleW(f"Nitro Generator and Checker - {len(valid)} Valid | {invalid} Invalid - Made by Vlad44#6969") # Change the title
                print("")
            else: # If it is a unix system
                print(f'\33]0;Nitro Generator and Checker - {len(valid)} Valid | {invalid} Invalid - Made by Vlad44#6969\a', end='', flush=True) # Change the title
